    ...
    <section style="background-color: #eee;">
        <div class="container py-5">
            <div class="row">
                ...
                <div class="mx-auto col-md-10">
                    <div class="mb-4 card">
                        <form class="card-body" action="{{ route('coming_soon.store') }}" method="post">
                            @csrf
                            <h4 class="mb-4 text-center">Create Coming Soon Page</h4>
                            <div class="mx-2 row">
                                ...
                                <div class="mx-auto mb-3 col-12">
                                    ...
                                    <textarea class="form-control" placeholder="Descriptions" name="descritions" rows="6">{{ old("descritions") }}</textarea>
                                </div>
