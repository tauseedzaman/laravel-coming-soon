    ...
    <section style="background-color: #eee;">
        <div class="container py-5">
            <div class="row">
                ...
                <div class="mx-auto col-md-10">
                    <div class="mb-4 card">
                        <form class="card-body" action="{{ route('admin.page.update', $page->id) }}" method="post">
                            @csrf
                            ...
                            <div class="mx-2 row">
                                <div class="mx-auto mb-3 col-12">
                                    ...
                                    <input class="form-control" id="Page Title" type="text" name="title"
                                        value="{{ $page->title }}" placeholder="Page Title">
                                </div>

                                <div class="mx-auto mb-3 col-12">
                                    <label class="form-label" for="Page Descriptions">Page Content</label>
                                    <textarea id="my-textarea" class="form-control" placeholder="Page Descriptions" name="content" rows="6">{!! $page->content !!}</textarea>
                                </div>
